...
**Project:** Kasir SABANA
**Generated:** 2026-09-04 19:33:26
**Category:** Restaurant/Food Service
**Design Dials:** Variance 4/10 (Balanced / Modern) | Motion 3/10 (Subtle) | Density 7/10 (Standard)

---

## UPDATE v3 — 2026-09-04 (berlaku & menggantikan bagian yang bertentangan)

Arah visual baru diputuskan bersama pemilik outlet (mockup `mockups/ui-v5-orientasi.html`):
**netral bersih + aksen merah SABANA**, responsif dua orientasi (landscape diutamakan di tablet kasir,
portrait otomatis di HP). Sumber kebenaran token: **`src/App.css` `:root`** (terang) & blok
`html[data-theme='gelap']` (gelap). Ringkasannya:

- **Warna** — latar abu sangat terang `#eef0f3`, kartu putih, tinta netral `#191d23`, aksen SABANA
  `#dc2626` dipakai hanya untuk mark, aksi utama, status aktif, dan badge; amber `#b45309` untuk stok
  menipis; hijau `#177245` untuk kembalian/sukses. Mode gelap: permukaan netral `#16181d`/`#20242b`,
  aksen terang `#e03535`, tinta `#eceef2`. Kontras teks ≥4.5:1 di kedua mode.
- **Tipografi** — Inter untuk seluruh UI (header/brand, body, angka tabular). Tidak ada font serif
  dekoratif lagi.
- **Mark/brand** — kotak merah `S` putih (sans 800), bukan tile emas/serif.
- **Layout kasir** — dua panel (menu ↔ pesanan+bayar) di ≥901px; HP/portrait menumpuk dengan dock bayar.
- **Ergonomi** — area sentuh ≥44px, stepper qty di kartu, uang cepat, kembalian besar, chip kategori
